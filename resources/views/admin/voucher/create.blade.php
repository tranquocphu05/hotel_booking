    ...
    <div class="max-w-lg mx-auto bg-white shadow rounded p-6 mt-6">
        ...
        <form action="{{ route('admin.voucher.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="gia_tri" class="w-full border rounded px-3 py-2" value="{{ old('gia_tri') }}"
                    min="1" max="100">
                @error('gia_tri')
                    <p class="error-text mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="number" name="so_luong" class="w-full border rounded px-3 py-2" value="{{ old('so_luong') }}"
                    min="1">
                @error('so_luong')
                    <p class="error-text mt-1">{{ $message }}</p>
                @enderror
