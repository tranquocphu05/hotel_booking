<footer class="bg-gray-900 text-gray-300 pt-12 pb-6">
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-10">
        ...
        <div>
            <div class="mb-4">
                <a href="{{ url('/') }}">
                    <img src="{{ asset('img/footer-logo.png') }}" alt="Hotel Booking Logo" class="h-10">
                </a>
            </div>
            <p class="text-sm mb-6 leading-relaxed">
                Chào mừng bạn đến với <span class="font-semibold text-white">Hotel Booking</span> —  
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                ...
                <li><i class="fa fa-envelope mr-2"></i> support@hotelbooking.vn</li>
        ...
        <div>
            ...
            <p class="text-sm mb-4">Nhận ngay các ưu đãi và khuyến mãi khách sạn mới nhất.</p>
    ...
    <div class="border-t border-gray-700 mt-10 pt-6">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm">
            ...
            <p class="text-gray-400 text-center md:text-right">
                © {{ date('Y') }} <span class="text-white font-semibold">Hotel Booking</span> —  
                Được phát triển ở 
