...
<aside id="admin-sidebar" class="w-64 bg-white shadow p-4 min-h-screen transform -translate-x-full md:translate-x-0 md:block transition-transform duration-300 ease-in-out">
    <div class="mb-6">
